# Contributing to Safe Logging

The Safe Logging project welcomes contributions from anybody wishing to participate. All code or documentation that is provided must be licensed with the same license that Safe Logging is licensed with (Apache 2.0, see [LICENSE](./LICENSE.md)).

## Code of Conduct

People are expected to follow the [Scala Code of Conduct](./CODE_OF_CONDUCT.md) when discussing Safe Logging on the Github page, Gitter channel, or other venues.
...
```
Copyright (c) $today.year the Safe Logging contributors.
See the project homepage at: https://ing-vesper.github.io/vesper-safelogging/
