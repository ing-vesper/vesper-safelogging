...
lazy val sharedSettings = Seq(
  projectTitle := "Safe Logging",
  projectWebsiteRootURL := "https://ing-vesper.github.io/",
  projectWebsiteBasePath := "/vesper-safelogging/",
  githubOwnerID := "ing-vesper",
  githubRelativeRepositoryID := "vesper-safelogging",
...
lazy val site = project.in(file("site"))
  ...
  .settings {
    ...
    Seq(
      ...
      micrositeDescription := "A pure FP library for logging, that prevents leaks of sensitive data.",
